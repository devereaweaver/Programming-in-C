/* Ch.10 - Exercise 4: Update insert function to allow an entry 
...
/* TO DO: add removeEntry() function to remove an entry from a linked
 * list. Only argument should be a pointer to the list (pointer to pointer 
 * to start of list). removeEntry() should remove the entry AFTER the one pointed
 * to by the argument. (Why can't you remove the entry pointed to by the argument?)
 */
